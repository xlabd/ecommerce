		...
		while($price = mysqli_fetch_array($run_query)){
		   ...
		   ?>
			...
			if(isset($_POST['update_cart'])){
				  ...
				  $q_query = " update products set p_quantity=p_quantity-'$qty'
				  where '$pro_id'=p_id";

				   $q_query_run = mysqli_query($con,$q_query);
		      ...
		      $ip = getIp();
		        ...
		        if(isset($_POST['update_cart'])){
					...
					foreach($_POST['remove'] as $remove_id)
					{
						...
						$qq_query = " update products set p_quantity=p_quantity+'$qty'
				  where '$pro_id'=p_id";

				   $qq_query_run = mysqli_query($con,$q_query);
						
						if($run_delete){
							
							echo "<script>
							alert('item deleted from the cart');
							window.open('cartc.php','_self');
							</script>";
						}
				...
				if(isset($_POST['continue']))
				{
					...
					echo"
					<script>window.open('indexc.php','_self')</script>
					";
