	...
	<!--main wrapper starts-->
	   <div class="main_wrapper">
		...
		<!--header wrapper starts-->
		 ...
		 <ul id="menu">
		   ...
		   <li><a href="cartc.php">Shopping Cart</a><li>
	 ...
	 <div id="shopping_cart">
		 ...
		 <div id='products_box'>
		   ...
		   <h2>YOUR ORDER HAS BEEN PLACED SUCCESSFULLY..<br><br>
		        PAYMENT MODE IS CASH ON DELIVERY..<br><br>
				THE PRODUCT WILL BE DELIVERED TO YOU AT YOUR REGISTERED ADDRESS IN 5-6 BUSINESS DAYS...<br><br>
				THANK YOU....<br><br>
				KEEP SHOPPING FROM SHOPNIX!!!</h2>   
