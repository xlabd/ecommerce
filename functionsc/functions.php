<?php
 ...
 function getcats(){
	 ...
	 while($row_cats = mysqli_fetch_array($run_cats))
	 {
		 ...
		 echo "<li><a href='indexc.php?cat=$cat_id'>$cat_title</a></li>";
	 }
 ...
 function getauthor(){
	 ...
	 while($row_author = mysqli_fetch_array($run_author))
	 {
		 ...
		 echo "<li><a href='indexc.php?author=$author_id'>$author_name</a></li>";
	 }
...
while($row_pro = mysqli_fetch_array($run_pro)){
	...
	<a href='indexc.php?add_cart=$pro_id'><button style='float:right'>Add to cart</button></a>
	           </div>
	           ";
      }	  
				 }
...
while($row_author_pro = mysqli_fetch_array($run_author_pro)){
        ...
        echo "
		      <div id='single_product'>
					...
					<p id='title1'><b>Price :$$pro_price</b></p>
	                  <a href='details.php?pro_id=$pro_id' style='text-decoration:none','float:left';>Details</a>
					  <a href='indexc.php?pro_id=$pro_id'><button style='float:right'>Add to cart</button></a>
	           </div>
	           ";
